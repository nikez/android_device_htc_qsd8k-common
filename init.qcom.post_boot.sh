...
case "$target" in
    "qsd8k")
        ...
        echo 40000 > /sys/devices/system/cpu/cpufreq/smartassv2/sampling_rate
        # CpuGovernorService
        chown system /sys/devices/system/cpu/cpufreq/smartassv2/sampling_rate
        chown system /sys/devices/system/cpu/cpufreq/smartassv2/io_is_busy
